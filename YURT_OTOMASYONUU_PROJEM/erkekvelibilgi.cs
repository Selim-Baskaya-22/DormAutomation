...
{
    public partial class erkekvelibilgi : Form
    {
        public erkekvelibilgi()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from erkekvel", baglanti);
        ...
        private void erkekvelibilgi_Load(object sender, EventArgs e)
        {
        ...
        private void btnekle_Click(object sender, EventArgs e)
        {
            ...
            {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into erkekvel values('"+combograd.Text+"','"+textad.Text+"','"+textsoyad.Text+"','"+texttel.Text+"','"+texttc.Text+"','"+int.Parse(textdogtar.Text)+"','"+textadres.Text+"')", baglanti);
...
baglanti.Open();
        ...
        private void btngüncelle_Click(object sender, EventArgs e)
        {
            ...
            {
baglanti.Open();
            SqlCommand komut = new SqlCommand("update erkekvel set  Ad='" + textad.Text + "',Soyad='" + textsoyad.Text + "',Tel_No='" + texttel.Text + "',Tc='" + texttc.Text + "',Doğum_Tarihi='" + textdogtar.Text + "',Adres='" + textadres.Text + "' where Öğrenci_Adı='" + combograd.Text + "'", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            listele();
            textsil();
