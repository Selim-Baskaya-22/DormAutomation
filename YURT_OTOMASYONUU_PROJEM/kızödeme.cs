...
{
    public partial class kızödeme : Form
    {
        public kızödeme()
        {
            InitializeComponent();
        ...
        void listele()
        {
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT  * FROM kızödeme", baglanti);
        ...
        private void kızödeme_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                kalan = kalan - ödenen;
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into kızödeme values('" + textBox2.Text + "','" + combograd.Text + "','" + textodenmesigereken.Text + "','" + ödenen + "','" + dateTimePicker1.Text + "','" + kalan + "')", baglanti);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("delete from kızödeme where Öğrenci_İd='" + textBox2.Text + "'", baglanti);
                komut.ExecuteNonQuery();
                baglanti.Close();
                listele();
                textsil();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                kalan = kalan - ödenen;
                baglanti.Open();
                SqlCommand komut = new SqlCommand("update kızödeme set Öğrenci_Adı='" + combograd.Text + "',Ödenen='" + int.Parse(textodenen.Text) + "',Kalan_Borç='" + kalan + "',Ödenen_Ay='" + dateTimePicker1.Text + "' where Öğrenci_İd='" + textBox2.Text + "'", baglanti);
                komut.ExecuteNonQuery();
                listele();
                textsil();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
   baglanti.Open();
            SqlDataAdapter komut = new SqlDataAdapter("select*from kızödeme where Öğrenci_Adı like '" + textBox1.Text + "'", baglanti);
